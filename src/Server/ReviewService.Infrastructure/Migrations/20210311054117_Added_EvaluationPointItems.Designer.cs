...
namespace ReviewService.Infrastructure.Migrations
{
    ...
    [Migration("20210311054117_Added_EvaluationPointItems")]
    partial class Added_EvaluationPointItems
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReviewService.Domain.Entites.EvaluationPointItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("EvaluationPointId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EvaluationPointId");

                    b.ToTable("EvaluationPointItems");
                });
            ...
            modelBuilder.Entity("ReviewService.Domain.Entites.EvaluationPointItem", b =>
                {
                    b.HasOne("ReviewService.Domain.Entites.EvaluationPoint", null)
                        .WithMany("EvaluationPointItems")
                        .HasForeignKey("EvaluationPointId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ReviewService.Domain.Entites.EvaluationPoint", b =>
                {
                    b.Navigation("EvaluationPointItems");
                });
